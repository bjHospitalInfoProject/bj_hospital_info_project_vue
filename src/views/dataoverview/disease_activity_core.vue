  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="评分时期">
        <template slot-scope="{row}">
          <span>{{ row.evaluationPeriodStr }}</span>
        </template>
      </el-table-column>
    ...
    <el-drawer title="评分详情" size="40%" :visible.sync="drawer" direction="rtl">
      ...
      <el-row class="custom">
        ...
        <el-col :span="5">
          <el-radio-group v-model="diseaseInfo.systemicSymptoms1">
            ...
            <el-radio :disabled="editVis" :label="无"></el-radio>
          </el-radio-group>
        </el-col>
      </el-row>
      <el-row class="custom">
      ...
      <el-row class="custom">
        ...
        <el-col :span="5">
          <el-input :disabled="true" style="width:150px" size="mini" v-model="diseaseInfo.itasScore"></el-input>
        </el-col>
      </el-row>
      ...
      <el-row class="custom">
        ...
        <el-col :span="5">
          <el-input :disabled="true" style="width:150px" size="mini" v-model="diseaseInfo.itasAScore"></el-input>
        </el-col>
      </el-row>
      ...
      <el-row class="custom">
        ...
        <el-col :span="5">
          <el-radio-group v-model="diseaseInfo.fatigueWeightLoss" @change="calculateITASAScore">
            <el-radio :disabled="editVis" :label="1">有 +1</el-radio>
            <el-radio :disabled="editVis" :label="0">无</el-radio>
          </el-radio-group>
        </el-col>
      ...
      <el-row class="custom">
        ...
        <el-col :span="5">
          <el-radio-group v-model="diseaseInfo.muscleJointPain" @change="calculateITASAScore">
            <el-radio :disabled="editVis" :label="1">有 +1</el-radio>
            <el-radio :disabled="editVis" :label="0">无</el-radio>
          </el-radio-group>
        </el-col>
...
export default {
  ...
  methods: {
    ...
    calculateITASAScore() {
      this.diseaseInfo.itasAScore = this.diseaseInfo.fatigueWeightLoss + this.diseaseInfo.muscleJointPain;
    }
  },
  computed: {
    ...mapGetters([
