                ...
                <el-row>
                    ...
                    <el-col :span="8" :lg="12" :xl="8">
                        <el-form-item label="IHC染色时间:">
                            <el-date-picker :disabled="editVis" v-model="IHCInfo.stainingTime" style="width:200px"
