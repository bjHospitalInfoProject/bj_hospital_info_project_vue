<template>
    <el-card class="box-card patientInfo">
        ...
        <div>
            <el-form label-width="200px" :model="HEInfo">
                <el-row>
                    ...
                    <el-col :span="8" :lg="12" :xl="8">
                        <el-form-item label="目前有无HE染色切片:">
                            <el-select :disabled="editVis" style="width:200px" size="mini" v-model="HEInfo.hasSlice"
                                placeholder="请选择">
                    ...
                    <el-col :span="8" :lg="12" :xl="8">
                        <el-form-item label="HE染色切片编号:">
                            <el-input :disabled="editVis" style="width:200px" size="mini"
                                v-model="HEInfo.sliceNumber"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    ...
                    <el-col :span="8" :lg="12" :xl="8">
                        <el-form-item label="HE染色切片扫描图像:">
                            <el-select :disabled="editVis" style="width:200px" size="mini" v-model="HEInfo.hasImage"
                                placeholder="请选择">
                                <el-option v-for="item in Options" :key="item.value" :label="item.label"
                                    :value="item.value">
                                </el-option>
                    ...
                    <el-col :span="8" :lg="12" :xl="8">
                        <el-form-item label="HE染色时间:">
                            <el-date-picker v-model="HEInfo.stainingTime" style="width:200px" size="mini" type="date"
                                placeholder="选择日期">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8" :lg="12" :xl="8">
                        <el-form-item label="当前保存位置:">
                            <el-select :disabled="editVis" style="width:200px" size="mini"
                                v-model="HEInfo.storageLocation" placeholder="请选择">
                ...
                <el-row>
                    <el-col :span="8" :lg="12" :xl="8">
                        <el-form-item label="组织性质:">
                            <el-select :disabled="editVis" style="width:200px" size="mini"
                                v-model="HEInfo.tissueProperty" placeholder="请选择">
                    ...
                    <el-col :span="8" :lg="12" :xl="8">
                        <el-form-item label="组织来源 (x动脉/周围x组织):">
                            <el-input :disabled="editVis" style="width:200px" size="mini"
                                v-model="HEInfo.tissueSource"></el-input>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    <el-col :span="8" :lg="12" :xl="8">
                        <el-form-item label="来源组织石蜡块ID:">
                            <el-input :disabled="editVis" style="width:200px" size="mini"
                                v-model="HEInfo.tissueParaffinBlockId"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8" :lg="12" :xl="8">
                        <el-form-item label="来源住院手术信息ID:">
                            <el-input :disabled="editVis" style="width:200px" size="mini"
                                v-model="HEInfo.surgeryInfoId"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="HE染色结果描述:">
                            <el-input :disabled="editVis" v-model="HEInfo.resultDescription" type="textarea" :rows="4"
                                placeholder="请输入内容">
                            </el-input>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="备注:">
                            <el-input :disabled="editVis" v-model="HEInfo.notes" type="textarea" :rows="4"
                                placeholder="请输入内容">
                            </el-input>
                        </el-form-item>
                    </el-col>
...
import { addOrUpdateHeSlice } from '@/api/dataentry'
